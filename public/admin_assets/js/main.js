$(document).ready(function() {
  $(document).change('#user_search', function() {
...
// **********SAUDIA**********
$('#saudia_client').keyup( function() {
  var client = $('#saudia_client').val();
  $.ajax({
    url: 'saudia_client',
    dataType: 'json',
    data:{'client' : client},
    success: function(data){
      $('#show_saudia_client').empty();
      ...
      $('#show_saudia_client').append(html);
        console.log(data)
      },
      error: function(a,b,c){
        console.log(b)
...
// **********PAKISTAN**********
$('#pakistan_client').keyup( function() {
  var client = $('#pakistan_client').val();
  $.ajax({
    url: 'pakistan_client',
    dataType: 'json',
    data:{'client' : client},
    success: function(data){
      $('#show_data_pakistan').empty();
      ...
      $.each(data, function(index, val) {
        ...
        '<td>'+val.transaction_id+'</td>'+
        '<td>'+val.status+'</td>'+
        '<td><a href="transaction/edit_transaction/'+val.id+'" class="btn btn-info btn-sm">Edit</a></td>';
        html += '</tr>';

      });
      
      $('#show_data_pakistan').append(html);
        console.log(data)
      },
      error: function(a,b,c){
        console.log(b)
